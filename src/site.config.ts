...
const config: SiteConfig = {
  ...
  site: 'https://unusuario2.github.io',
  base: '/unsuario2_website',
  // The name of your site, used in the title and for SEO.
  title: 'Unsuario2 Portfolio',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Unsuario2 website to share projects',
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Unusuario2',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/Unusuario2',
    email: '',
    linkedin: '',
